...
@section('content')
            ...
            <div class="thumbnail mobile">              
              <div class="bt">
                ...
                <div class="intro pull-right">
                  ...
                  @endif 
                    <li><span class="glyphicon glyphicon-ok-sign"></span>Cài đặt phần mềm, tải nhạc - ứng dụng miến phí</li> 
                </div><!-- /div introl -->
              </div> <!-- /div bt -->
              <div class="ct">
    ...
    <div class="panel panel-info">
      ...
      <div class="panel-body">
        Hãy <a href="https://www.facebook.com/toidicodedao" title="">Like</a> facebook của KBPT để cập nhật tin mới nhất
      </div>
    </div> <!-- /fan pages myweb -->        
  </div> 
</div>
